...
//    }
//
//    override fun insertGroup(group: Groups) {
//        val database = this.writableDatabase
//        val contentValues = ContentValues()
...
//
//    @SuppressLint("Recycle")
//    override fun getAllGroup(query: String): ArrayList<Groups> {
//        val groupList = ArrayList<Groups>()
//        val database = this.readableDatabase
//        val cursor = database.rawQuery(query, null)
//        if (cursor.moveToFirst()) {
//            do {
//                val group = Groups(cursor.getInt(0),
//                    cursor.getString(1),
//                    cursor.getString(2),
//                    cursor.getString(3),
//                    cursor.getInt(4),
...
//    }
//
//    override fun updateGroup(group: Groups) {
//        val database = this.writableDatabase
//        val contentValues = ContentValues()
...
//    }
//
//    override fun deleteGroup(group: Groups) {
//        val database = this.writableDatabase
